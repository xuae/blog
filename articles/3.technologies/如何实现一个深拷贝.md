...
javascript拥有多种对象类型判断方式，这里我们主要讲三种：构造函数（constructor），原型链，内置函数（typeof）。instanceof 运算符用来检测 constructor.prototype 是否存在于参数 object 的原型链上，https://juejin.cn/post/6844903984335945736#heading-19详细讲述了原型链的知识，感兴趣的童鞋可以看一看
